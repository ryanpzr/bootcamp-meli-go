...
func (h *CustomersDefault) Populate() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (h *CustomersDefault) GetCondition() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		result, err := h.sv.GetCondition()
		if err != nil {
			response.Error(w, http.StatusInternalServerError, "error: "+err.Error())
			return
		}
...
func (h *CustomersDefault) GetRankingCus() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		result, err := h.sv.GetRankingCus()
		if err != nil {
			response.Error(w, http.StatusInternalServerError, "error: "+err.Error())
			return
		}
